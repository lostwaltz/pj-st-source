...
public class UILegendaryGachaPanel : UIBase
{
    ...
    void Start()
    {
        ...
        if (Core.CurrencyManager.GetAmount<Credits>() < 50)
        {
        ...
        if (Core.CurrencyManager.GetAmount<Credits>() < 500)
        {
    ...
    {
        if (Core.CurrencyManager.Spend<Credits>(50) == false)
        {
    ...
    {
        if (Core.CurrencyManager.Spend<Credits>(500) == false)
        {
            Core.UIManager.OpenUI<UIGachaWarningPanel>();
            return;
        }
