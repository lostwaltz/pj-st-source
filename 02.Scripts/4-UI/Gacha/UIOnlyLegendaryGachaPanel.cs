...
public class UIOnlyLegendaryGachaPanel : UIBase
{
    ...
    void Start()
    {
        ...
        oneAccessIconText.text = "X100";
        tenAccessIconText.text = "X1000";
        ...
        if (Core.CurrencyManager.GetAmount<Credits>() < 1000)
        {
    ...
    {
        if (Core.CurrencyManager.Spend<Credits>(1000) == false)
        {
            Core.UIManager.OpenUI<UIGachaWarningPanel>();
            return;
        }
